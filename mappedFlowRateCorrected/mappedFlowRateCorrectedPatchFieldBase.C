...
template<class Type>
Type Foam::mappedFlowRateCorrectedPatchFieldBase<Type>::getAverage
(
...
template<class Type>
template<class T>
void Foam::mappedFlowRateCorrectedPatchFieldBase<Type>::storeField
(
...
template<class Type>
template<class T>
bool Foam::mappedFlowRateCorrectedPatchFieldBase<Type>::retrieveField
(
...
template<class Type>
template<class T>
void Foam::mappedFlowRateCorrectedPatchFieldBase<Type>::initRetrieveField
(
    const objectRegistry& obr,
    const word& region,
    const word& patch,
...
template<class Type>
template<class T>
bool Foam::mappedFlowRateCorrectedPatchFieldBase<Type>::storeAndRetrieveField
(
    const word& fieldName,
    const label myComm,
...
template<class Type>
Foam::mappedFlowRateCorrectedPatchFieldBase<Type>::mappedFlowRateCorrectedPatchFieldBase
(
...
:
    mappedFlowRateCorrectedPatchFieldBase<Type>::mappedFlowRateCorrectedPatchFieldBase(mapper, patchField, dict)
{
...
Foam::mappedFlowRateCorrectedPatchFieldBase<Type>::mappedFlowRateCorrectedPatchFieldBase
(
    const mappedFlowRateCorrectedPatchFieldBase<Type>& mapper
)
:
...
(
    const mappedPatchBase& mapper,
    const fvPatchField<Type>& patchField,
    const mappedFlowRateCorrectedPatchFieldBase<Type>& base
)
:
    mapper_(mapper),
    patchField_(patchField),
...
Foam::mappedFlowRateCorrectedPatchFieldBase<Type>::sampleField(const word& fieldName) const
{
...
Foam::mappedFlowRateCorrectedPatchFieldBase<Type>::sampleField() const
{
...
template<class Type>
template<class T>
void Foam::mappedFlowRateCorrectedPatchFieldBase<Type>::distribute
(
    const word& fieldName,
    Field<T>& fld
) const
...
Foam::mappedFlowRateCorrectedPatchFieldBase<Type>::mappedField
(
...
//template<class Type>
//Foam::tmp<Foam::Field<Type>>
//Foam::mappedFlowRateCorrectedPatchFieldBase<Type>::mappedField() const
//{
...
template<class Type>
Foam::tmp<Foam::Field<Type>>
Foam::mappedFlowRateCorrectedPatchFieldBase<Type>::mappedInternalField() const
{
...
Foam::mappedFlowRateCorrectedPatchFieldBase<Type>::mappedWeightField() const
{
    // Swap to obtain full local values of neighbour internal field
...
template<class Type>
void Foam::mappedFlowRateCorrectedPatchFieldBase<Type>::mappedWeightField
(
    const word& fieldName,
...
template<class Type>
const Foam::mappedPatchBase& Foam::mappedFlowRateCorrectedPatchFieldBase<Type>::mapper
(
    const fvPatch& p,
...
template<class Type>
void Foam::mappedFlowRateCorrectedPatchFieldBase<Type>::write(Ostream& os) const
{
